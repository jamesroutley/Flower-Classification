...
% 2) Refactor CNN section. Single function which loads / generates standard,
% mirrored, sampled matrices. Use vectors to split up matrices afterwards.
% 1) Refactor training/test index vectors to use zeros(17, 40), reshape. Save
% weight matrices?

% Split cnn_feature_extract into cnn_feature_extract (input: image bitmap,
% output: normalised feature vector) and cnn_image_load. 
